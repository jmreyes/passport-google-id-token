...
GoogleTokenStrategy.prototype.authenticate = function(req, options) {
  ...
  if (req.query && req.query.error) {
    ...
    self._verifyGoogleToken(parser, accessToken, googleId, self._clientID, function(err, parsedToken) {
 ...
 * @api protected
 */
GoogleTokenStrategy.prototype._verifyGoogleToken = function(parser, accessToken, googleId, clientID, done) {  
